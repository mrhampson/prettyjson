...
// ### Module dependencies
var PLATFORM_EOL_CONSTANT = require('os').EOL;
...
var indentLines = function(string, spaces){
  ...
  var lineEnding = options.usePlatformEol ? PLATFORM_EOL_CONSTANT : '\n';
...
exports.render = function render(data, options, indentation) {
  ...
  options.usePlatformEol = options.usePlatformEol || false;

  var lineEnding = options.usePlatformEol ? PLATFORM_EOL_CONSTANT : '\n'
  return renderToArray(data, options, indentation).join(lineEnding);
};
